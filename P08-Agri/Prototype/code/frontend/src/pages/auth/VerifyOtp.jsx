        ...
        <div className="hidden lg:block lg:flex-1 bg-[#2D6A4F] relative overflow-hidden">
          ...
          <div className="relative h-full flex items-center justify-center p-12">
            <div className="max-w-md text-white space-y-6">
              <h2 className="text-[28px] font-semibold leading-tight">{t.verifyOtp.errorHeroTitle}</h2>
              <p className="text-[#B8E0D2] leading-relaxed text-[15px]">
                {t.verifyOtp.errorHeroDescription}
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-[#FAFDF7] flex relative">
      ...
      <div className="hidden lg:block lg:flex-1 bg-[#2D6A4F] relative overflow-hidden">
        ...
        <div className="relative h-full flex items-center justify-center p-12">
          <div className="max-w-md text-white space-y-6">
            <h2 className="text-[28px] font-semibold leading-tight">{t.verifyOtp.heroTitle}</h2>
            <p className="text-[#B8E0D2] leading-relaxed text-[15px]">
              {t.verifyOtp.heroDescription}
            </p>
            <div className="space-y-3 pt-4">
              <div className="flex items-start gap-3">
                ...
                <span className="text-sm">{t.verifyOtp.heroFeature1}</span>
              </div>
              <div className="flex items-start gap-3">
                <svg className="w-5 h-5 text-[#52B788] flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
                </svg>
                <span className="text-sm">{t.verifyOtp.heroFeature2}</span>
              </div>
              <div className="flex items-start gap-3">
                <svg className="w-5 h-5 text-[#52B788] flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <span className="text-sm">{t.verifyOtp.heroFeature3}</span>
              </div>
            </div>
          </div>
        </div>
